const AuthenticationResourceEN = {
  ...
  placeholder_user_name: 'Enter your email',
  ...
  fail_sign_up_user_name_existed: 'This email is registered already or the email format is invalid.',
  ...
  error_confirmed_password: 'Confirmed password and password are not matched.',
